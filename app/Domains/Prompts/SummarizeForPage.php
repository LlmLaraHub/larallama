...
**Format**: Produce the summary in markdown format, utilizing appropriate markdown elements like headings, bullet points, and brief paragraphs to ensure the summary is well-organized and easy to read on a web page. The summary should not exceed 10 lines.
