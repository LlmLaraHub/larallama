...
const form = useForm({
    _method: 'PUT',
    api_key: props.setting.secrets?.groq?.api_key,
    api_url: props.setting.secrets?.groq?.api_url,
});
...
<template>
    <FormSection @submitted="updateSecrets">
        ...
        <template #description>
            ...
            <a
                class="underline"
                href="https://console.groq.com/docs/quickstart" target="_blank">here</a>
        </template>
