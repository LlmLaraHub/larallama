...
import OpenAiSecrets from "@/Pages/Settings/Partials/OpenAiSecrets.vue";
...
import MainPrompt from "@/Pages/Settings/Partials/MainPrompt.vue";
        ...
        <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
               <div>
                ...
                <div>
                    <ClaudeSecrets :setting="setting.data"/>
                    <SectionBorder/>
                </div>

                <div>
                    <OllamaApiSecrets :setting="setting.data"/>
                    <SectionBorder/>
                </div>
                ...
                <div>
                    <MainPrompt :setting="setting.data"/>
                    <SectionBorder/>
                </div>
            </div>
        </div>
